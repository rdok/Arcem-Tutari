...
public class SkyDomeControl implements Control {
	...
	private float cycleSpeed = .125f; // 125
	 ...
	 * sky
	 * @param moonMap The string value of the texture asset for the moon. This is
	...
	public SkyDomeControl(AssetManager assetManager, Camera cam, String model, String nightSkyMap, String moonMap, String cloudsMap, String fogAlphaMap) {
		...
		skyNight.setLocalScale(650, 650, 650);
		skyNight.setLocalTranslation(skyNight.getLocalTranslation().x, skyNight.getLocalTranslation().y , skyNight.getLocalTranslation().z);
...
// Day to night/night to day cycles
	...
	public void update(float tpf) {
		if (spatial != null && enabled) {
			...
			// 
			spatial.setLocalTranslation(camLF[0] + 1000, camLF[1] + .25f, camLF[2]);
